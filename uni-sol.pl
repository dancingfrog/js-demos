...
get '/vision' => sub {
	...
	$self->stash( mediaDIV => '<div id="stream" style="text-align: center"><br /><audio id="aud1" preload="auto" controls="true"><source src="/js-demos/audio/fft-track.mp3" /><source src="/js-demos/audio/fft-track.ogg" /></audio></div>' );
	$self->render('vision');
};
